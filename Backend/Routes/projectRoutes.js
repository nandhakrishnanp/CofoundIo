...
const { getAllTeams, newProject, getMyProject, addJoinRequest, getMyNotification, acceptJoinRequest, rejectJoinRequest, getMembersDetails } = require("../Controllers/projectController");
const auth = require("../Middleware/auth");
const router = express.Router()
router.get("/getMembersDetails/:projectId",auth,getMembersDetails)
